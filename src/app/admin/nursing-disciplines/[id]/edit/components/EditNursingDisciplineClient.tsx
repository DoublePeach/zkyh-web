...
interface EditNursingDisciplineClientProps {
    id: string;
}

export default function EditNursingDisciplineClient({ id }: EditNursingDisciplineClientProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      {/* Header part is removed, should be in the server component page */}
      <Card>
        <CardHeader>
